...
// TernaryCarryReduction) or (TernaryFormReduction) composing two of them
// together. Reduction itself (reduction.hpp) is just the shared interface
// -- see each file's own class comment for building a custom reduction
// directly. Mirrors plan_zoo.hpp/transformation_zoo.hpp/representation_zoo.hpp.
