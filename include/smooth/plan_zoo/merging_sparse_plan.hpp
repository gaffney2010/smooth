...
// every multiply, both operands are first run through MergeReduction
// (reduction_zoo/merge_reduction.hpp) -- greedily combining every
...
// at runtime, from the real bits -- unlike Ensure, a Reduce blueprint
...
private:
    ...
    // itself the result of a nested Add/Multiply -- in a Reduce node
    // running reduction_. Add nodes are left alone.
